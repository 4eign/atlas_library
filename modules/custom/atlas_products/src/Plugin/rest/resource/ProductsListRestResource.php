 ...
 *
 * @RestResource(
 *   id = "products_list_rest_resource",
 *   label = @Translation("Products list rest resource"),
 *   uri_paths = {
 *     "canonical" = "/api/products"
 *   }
 * )
 */
class ProductsListRestResource extends ResourceBase {
  ...
  /**
   * Constructs a new ProductsListRestResource object.
   *
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $container->get('logger.factory')->get('atlas_products'),
